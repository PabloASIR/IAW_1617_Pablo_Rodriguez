...
<head>
  ...
  <body>
      ...
      <?php
        ...
        <!--    <span>film_id:</span><input type="text" name="id" required><br> -->
            ...
            <span>serie_sinopsis:</span><input type="text" name="sinopsis" ><br>
            <span>serie_trailer:</span><input type="text" name="trailer"><br>
            <span>serie_date_release:</span><input type="date" name="date_release" ><br>
  ...
  if (isset($_POST['send'])) {
    ...
    if ($valid) {
      ...
      $consulta= "INSERT INTO series VALUES('$id','$name','$gender','$sinopsis','$trailer','$date_release','$target_file');";
      ...
      if (!$result) {
         ...
         echo "Query Error";
          ...
          echo "New SERIE added";
      }
      echo '<br>';
      echo "<form action='newserie.php'>
